  ...
  return (
    <div className="flex flex-col items-center justify-center h-[80vh] text-center max-w-2xl mx-auto px-4">
      ...
      <p className="text-muted-foreground text-lg mb-8 leading-relaxed">
        We're building an incredible gallery of hyper-optimized prompts for AI video generators like Sora, Runway, and Pika. 
        Soon you'll be able to instantly generate stunning video assets for your projects with a single click.
      </p>
