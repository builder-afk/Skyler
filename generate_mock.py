...
items = [
    {
        ...
        "analysis": {
            ...
            "designKeywords": ["Moody", "Atmospheric", "Forest", "Mountains", "Nature", "Fog", "Dark Green"],
            "keyElements": {
                "colorPalette": [
                    {"name": "Deep Pine", "hex": "#1B2A22"},
                    {"name": "Fog Gray", "hex": "#A4B0AF"},
                    {"name": "Muted Sage", "hex": "#5D6F61"},
                    {"name": "Charcoal", "hex": "#1E2022"}
                ],
                "typography": "N/A",
    ...
    },
    {
        ...
        "analysis": {
            ...
            "designKeywords": ["Golden Hour", "Mountains", "Warm Lighting", "Adventure", "Landscape", "Epic"],
            "keyElements": {
                "colorPalette": [
                    {"name": "Sunset Gold", "hex": "#FFB347"},
                    {"name": "Warm Orange", "hex": "#E07A5F"},
                    {"name": "Deep Shadow", "hex": "#264653"},
                    {"name": "Sky Blue", "hex": "#8AB4F8"}
                ],
                "typography": "N/A",
    ...
    },
    {
        ...
        "analysis": {
            ...
            "designKeywords": ["Tropical", "Beach", "Ocean", "Vibrant", "Turquoise", "Relaxing", "Summer"],
            "keyElements": {
                "colorPalette": [
                    {"name": "Turquoise Water", "hex": "#40E0D0"},
                    {"name": "White Sand", "hex": "#FFFDD0"},
    ...
    },
    {
        ...
        "analysis": {
            ...
            "designKeywords": ["Jungle", "Lush", "Canopy", "Sunbeams", "Greenery", "Vibrant", "Organic"],
            "keyElements": {
                "colorPalette": [
                    {"name": "Vibrant Leaf", "hex": "#4CAF50"},
                    {"name": "Deep Canopy", "hex": "#1B5E20"},
                    {"name": "Sunbeam Yellow", "hex": "#FFF59D"},
                    {"name": "Bark Brown", "hex": "#5D4037"}
                ],
                "typography": "N/A",
    ...
    },
    {
        ...
        "analysis": {
            ...
            "designKeywords": ["Autumn", "Fall Colors", "Forest Path", "Warm", "Nostalgic", "Cozy"],
            "keyElements": {
                "colorPalette": [
                    {"name": "Burnt Orange", "hex": "#CC5500"},
                    {"name": "Golden Yellow", "hex": "#FFD700"},
                    {"name": "Crimson Red", "hex": "#8B0000"},
                    {"name": "Earthy Brown", "hex": "#654321"}
                ],
                "typography": "N/A",
    ...
    },
    {
        ...
        "analysis": {
            ...
            "designKeywords": ["Lake", "Reflection", "Symmetry", "Calm", "Peaceful", "Alpine", "Cool Tones"],
            "keyElements": {
                "colorPalette": [
                    {"name": "Deep Water Blue", "hex": "#1E3F66"},
                    {"name": "Sky Cyan", "hex": "#73C2FB"},
                    {"name": "Stone Gray", "hex": "#8A9A5B"},
                    {"name": "Snow White", "hex": "#F0F8FF"}
                ],
                "typography": "N/A",
    ...
    },
    {
        ...
        "analysis": {
            ...
            "designKeywords": ["Macro", "Dew Drops", "Leaf", "Fresh", "Green", "Detailed", "Organic Geometry"],
            "keyElements": {
                "colorPalette": [
                    {"name": "Spring Green", "hex": "#00FF7F"},
                    {"name": "Lime", "hex": "#32CD32"},
                    {"name": "Deep Vein Green", "hex": "#006400"},
                    {"name": "Water Highlight", "hex": "#E0FFFF"}
                ],
                "typography": "N/A",
    ...
    },
    {
        ...
        "analysis": {
            ...
            "designKeywords": ["Desert", "Sand Dunes", "Minimalist", "Warm", "Curves", "Abstract Landscape"],
            "keyElements": {
                "colorPalette": [
                    {"name": "Dune Gold", "hex": "#C2B280"},
                    {"name": "Shadow Bronze", "hex": "#8B7355"},
                    {"name": "Pale Blue Sky", "hex": "#B0E0E6"},
                    {"name": "Sunlight Yellow", "hex": "#F5DEB3"}
                ],
                "typography": "N/A",
    ...
    },
    {
        ...
        "analysis": {
            ...
            "designKeywords": ["Waterfall", "Dynamic", "Powerful", "Motion", "Nature", "Misty", "Epic"],
            "keyElements": {
                "colorPalette": [
                    {"name": "White Water", "hex": "#F0F8FF"},
                    {"name": "Deep River Blue", "hex": "#005C8A"},
                    {"name": "Moss Green", "hex": "#4A5D23"},
                    {"name": "Dark Wet Rock", "hex": "#2F4F4F"}
                ],
                "typography": "N/A",
    ...
    },
    {
        ...
        "analysis": {
            ...
            "designKeywords": ["Ocean", "Waves", "Moody", "Dark Blue", "Texture", "Rhythm", "Mysterious"],
            "keyElements": {
                "colorPalette": [
                    {"name": "Abyss Blue", "hex": "#001F3F"},
                    {"name": "Midnight Teal", "hex": "#003366"},
                    {"name": "Foam Gray", "hex": "#B0C4DE"},
    ...
    },
    {
        ...
        "analysis": {
            ...
            "designKeywords": ["Sunflowers", "Sunset", "Vibrant", "Warm", "Happy", "Floral", "Pastoral"],
            "keyElements": {
                "colorPalette": [
                    {"name": "Sunflower Yellow", "hex": "#FFC300"},
                    {"name": "Sunset Orange", "hex": "#FF5733"},
                    {"name": "Stem Green", "hex": "#6B8E23"},
                    {"name": "Dark Center", "hex": "#3E2723"}
                ],
                "typography": "N/A",
    ...
    },
    {
        ...
        "analysis": {
            ...
            "designKeywords": ["Moss", "Forest Floor", "Ferns", "Green", "Textured", "Micro-ecosystem", "Earthy"],
            "keyElements": {
                "colorPalette": [
                    {"name": "Vibrant Moss", "hex": "#556B2F"},
                    {"name": "Fern Green", "hex": "#228B22"},
                    {"name": "Soil Brown", "hex": "#3E2723"},
    ...
    },
    {
        ...
        "analysis": {
            ...
            "designKeywords": ["Winter", "Snow", "Pine Trees", "Minimalist", "Cold", "Pristine", "White"],
            "keyElements": {
                "colorPalette": [
                    {"name": "Pure Snow", "hex": "#FAFAFA"},
                    {"name": "Frost Blue", "hex": "#E0FFFF"},
                    {"name": "Dark Pine", "hex": "#2F4F4F"},
                    {"name": "Overcast Gray", "hex": "#D3D3D3"}
                ],
                "typography": "N/A",
    ...
    },
    {
        ...
        "analysis": {
            ...
            "designKeywords": ["Canyon", "Red Rocks", "Geology", "Vast", "Rugged", "Warm Tones", "Desert"],
            "keyElements": {
                "colorPalette": [
                    {"name": "Canyon Red", "hex": "#CB4154"},
                    {"name": "Sandstone Orange", "hex": "#ED9121"},
                    {"name": "Desert Sky", "hex": "#00BFFF"},
                    {"name": "Deep Crevice", "hex": "#4A0404"}
                ],
                "typography": "N/A",
    ...
    },
    {
        ...
        "analysis": {
            ...
            "designKeywords": ["Coastal", "Cliffs", "Ocean", "Dramatic", "Moody", "Wild", "Rugged"],
            "keyElements": {
                "colorPalette": [
                    {"name": "Storm Gray", "hex": "#708090"},
                    {"name": "Sea Green", "hex": "#2E8B57"},
                    {"name": "Granite Gray", "hex": "#696969"},
    ...
    },
    {
        ...
        "analysis": {
            ...
            "designKeywords": ["Aurora", "Northern Lights", "Night Sky", "Ice", "Magical", "Glowing", "Green"],
            "keyElements": {
                "colorPalette": [
                    {"name": "Aurora Green", "hex": "#39FF14"},
                    {"name": "Night Sky Blue", "hex": "#0B0B45"},
    ...
    },
    {
        ...
        "analysis": {
            ...
            "designKeywords": ["Butterfly", "Macro", "Wildlife", "Vibrant", "Delicate", "Symmetry", "Colorful"],
            "keyElements": {
                "colorPalette": [
                    {"name": "Monarch Orange", "hex": "#FF4500"},
                    {"name": "Velvet Black", "hex": "#0A0A0A"},
                    {"name": "Pollen Yellow", "hex": "#FFD700"},
                    {"name": "Soft Green Bokeh", "hex": "#9ACD32"}
                ],
                "typography": "N/A",
    ...
    },
    {
        ...
        "analysis": {
            ...
            "designKeywords": ["Aerial", "Drone", "Forest", "Fog", "Texture", "Moody", "Pattern"],
            "keyElements": {
                "colorPalette": [
                    {"name": "Evergreen", "hex": "#2E4A35"},
                    {"name": "Mist White", "hex": "#E8ECEF"},
                    {"name": "Deep Shadow", "hex": "#1A2421"},
                    {"name": "Pale Gray", "hex": "#BFC9CA"}
                ],
                "typography": "N/A",
    ...
    },
    {
        ...
        "analysis": {
            ...
            "designKeywords": ["Leaf", "Tropical", "Backlit", "Vivid Green", "Graphic", "Summer", "Organic Shapes"],
            "keyElements": {
                "colorPalette": [
                    {"name": "Translucent Green", "hex": "#7CFC00"},
                    {"name": "Deep Vein", "hex": "#006400"},
                    {"name": "Sunlight Yellow", "hex": "#FFFFE0"},
                    {"name": "Shadow Green", "hex": "#228B22"}
                ],
                "typography": "N/A",
    ...
    },
    {
        ...
        "analysis": {
            ...
            "designKeywords": ["Astrophotography", "Milky Way", "Stars", "Night Sky", "Mountains", "Cosmic", "Wonder"],
            "keyElements": {
                "colorPalette": [
                    {"name": "Space Violet", "hex": "#4B0082"},
                    {"name": "Starry White", "hex": "#FFFFA6"},
                    {"name": "Deep Space Blue", "hex": "#000033"},
                    {"name": "Silhouette Black", "hex": "#050505"}
                ],
                "typography": "N/A",
...
out = """export interface ColorSwatch {
  name: string
  hex: string
}
...
export const MOCK_GALLERY: GalleryItem[] = """ + json.dumps(items, indent=2)

with open('src/app/(app)/image-prompts/mock-data.ts', 'w') as f:
    f.write(out)
